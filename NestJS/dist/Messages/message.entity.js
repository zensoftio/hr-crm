...
__decorate([
    typeorm_1.ManyToOne(type => template_entity_1.Templates, template => template.messages),
    __metadata("design:type", template_entity_1.Templates)
], Message.prototype, "template", void 0);
__decorate([
    typeorm_1.OneToMany(type => recipient_entity_1.Recipient, recipients => recipients.message),
